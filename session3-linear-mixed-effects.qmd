...
- Fitting Linear Mixed Models (LMMs) or Generalized Linear Mixed Models (GLMMs) is described [here](https://repsychling.github.io/SMLP2022) and [here]
There are several places where the use of this package is described.  Here
