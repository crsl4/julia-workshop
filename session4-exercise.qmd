...
- Do you have Julia installed? If not, go to the [housekeeping notes](session0-housekeeping.qmd)
- Do you have your project folder and installed dependencies? If not, go to the [getting started nodes](session1-get-started.qmd)
