...
Note that `(@v1.8) pkg> add PyCall` will use the `Conda.jl` package to install a minimal Python distribution (via Miniconda) that is private to Julia (not in your PATH).
...
- [List of useful packages by SMLP2022](https://github.com/RePsychLing/SMLP2022/blob/main/notebooks/useful_packages.qmd)

![](docs/pics/julia4bio.png)
