...
<div style="text-align:center"><img src="docs/pics/julia-adoption.png" width="450"/></div>
...
# Opening the julia code

There are many ways to work on julia code depending on the editor.

For those using VSCode, you can open the project easily with:
```shell
cd julia-workshop
code .
```
