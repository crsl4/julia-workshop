...
So, for example, the fully qualified name, `Tar.extract`, must be used to call the `extract` function in the `Tar` package's Module, as in Python.
The function `varinfo` provides a listing of the names exported by a module.
