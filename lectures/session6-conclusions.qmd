...
1. Data tools:
  ...
  - [DataFrames.jl](https://github.com/JuliaData/DataFrames.jl): [cheatsheet](https://ahsmart.com/assets/pages/data-wrangling-with-data-frames-jl-cheat-sheet/DataFramesCheatSheet_v0.22_rev1.pdf) similar to `tidyverse`; split-apply-combine
...
- Data visualization: no `ggplot2` yet
  - [add reference here to the other tools section on Plots]
- Literate programming: no `knitr` yet, but [quarto.org](https://quarto.org/) handles Julia well
  - This notes were rendered with quarto!
